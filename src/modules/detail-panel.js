...
function _openResourceSpotlight(rid) {
  ...
  h +=
    '<span class="sl-id" title="Click to copy" onclick="navigator.clipboard&&navigator.clipboard.writeText(\'' +
    _escHtml(rid) +
    '\')">' +
    _escHtml(rid) +
    '</span>';
...
function _openDetailForSearch(type, id) {
  ...
  if (type === 'VPC') {
    ...
    dpSub.innerHTML =
      ...
      esc(vpc.CidrBlock || '');
    h +=
      '<div class="dp-section"><div class="dp-sec-hdr" onclick="this.classList.toggle(\'collapsed\');this.nextElementSibling.classList.toggle(\'hidden\')"><span class="dp-sec-title">Overview</span><span class="dp-sec-arr">&#9660;</span></div><div class="dp-sec-body">';
    ...
    if (subs.length) {
      h +=
        '<div class="dp-section"><div class="dp-sec-hdr" onclick="this.classList.toggle(\'collapsed\');this.nextElementSibling.classList.toggle(\'hidden\')"><span class="dp-sec-title">Subnets</span><span><span class="dp-sec-count">' +
        subs.length +
      ...
      subs.forEach((s) => {
        ...
        h +=
          '<div style="padding:4px 0;cursor:pointer;color:var(--accent-cyan);font-size:calc(11px * var(--dp-txt-scale,1))" onclick="_openDetailForSearch(\'Subnet\',\'' +
          esc(s.SubnetId) +
          "');_zoomToElement('" +
          esc(s.SubnetId) +
          '\')">' +
    ...
    if (gws.length) {
      h +=
        '<div class="dp-section"><div class="dp-sec-hdr" onclick="this.classList.toggle(\'collapsed\');this.nextElementSibling.classList.toggle(\'hidden\')"><span class="dp-sec-title">Gateways</span><span><span class="dp-sec-count">' +
        gws.length +
        '</span><span class="dp-sec-arr">&#9660;</span></span></div><div class="dp-sec-body">';
      gws.forEach((g) => {
        h +=
          '<div style="padding:4px 0;cursor:pointer;color:' +
          gcv(g.type) +
          ';font-size:calc(11px * var(--dp-txt-scale,1))" onclick="_openDetailForSearch(\'' +
          g.type +
          "','" +
          esc(g.id) +
          '\')">' +
    ...
    h +=
      '<div class="dp-section"><div class="dp-sec-hdr" onclick="this.classList.toggle(\'collapsed\');this.nextElementSibling.classList.toggle(\'hidden\')"><span class="dp-sec-title">Details</span><span class="dp-sec-arr">&#9660;</span></div><div class="dp-sec-body">';
    h += '<table class="dp-kv">';
    ...
    h +=
      '<tr><td>Subnet</td><td><span style="cursor:pointer;color:var(--accent-cyan)" onclick="_openDetailForSearch(\'Subnet\',\'' +
      esc(inst.SubnetId) +
      "');_zoomToElement('" +
      esc(inst.SubnetId) +
      '\')">' +
      ...
      '</span></td></tr>';
    h +=
      '<tr><td>VPC</td><td><span style="cursor:pointer;color:var(--accent-cyan)" onclick="_openDetailForSearch(\'VPC\',\'' +
      esc(inst.VpcId) +
      '\')">' +
      esc(inst.VpcId || '—') +
      '</span></td></tr>';
    ...
    if (sgsArr.length) {
      h +=
        '<div class="dp-section"><div class="dp-sec-hdr" onclick="this.classList.toggle(\'collapsed\');this.nextElementSibling.classList.toggle(\'hidden\')"><span class="dp-sec-title">Security Groups</span><span><span class="dp-sec-count">' +
        sgsArr.length +
        '</span><span class="dp-sec-arr">&#9660;</span></span></div><div class="dp-sec-body">';
      sgsArr.forEach((s) => {
        h +=
          '<div style="padding:4px 0;cursor:pointer;color:var(--accent-cyan);font-size:calc(11px * var(--dp-txt-scale,1))" onclick="_openDetailForSearch(\'SG\',\'' +
          esc(s.GroupId) +
          '\')">' +
    ...
    if (vpcCfg && vpcCfg.VpcId) {
      ...
      h +=
        ...
        (vpcCfg.SubnetIds || [])
          .map(
            (s) =>
              '<span style="cursor:pointer;color:var(--accent-cyan)" onclick="_openDetailForSearch(\'Subnet\',\'' +
              esc(s) +
              "');_zoomToElement('" +
              esc(s) +
              '\')">' +
    ...
    if (inRules.length) {
      h +=
        '<div class="dp-section"><div class="dp-sec-hdr" onclick="this.classList.toggle(\'collapsed\');this.nextElementSibling.classList.toggle(\'hidden\')"><span class="dp-sec-title">Inbound Rules</span><span><span class="dp-sec-count">' +
        inRules.length +
    ...
    if (outRules.length) {
      h +=
        '<div class="dp-section"><div class="dp-sec-hdr collapsed" onclick="this.classList.toggle(\'collapsed\');this.nextElementSibling.classList.toggle(\'hidden\')"><span class="dp-sec-title">Outbound Rules</span><span><span class="dp-sec-count">' +
        outRules.length +
...
function _addTimelineDot(container, snap, x, idx) {
  ...
  dot.addEventListener('contextmenu', function (ev) {
    ev.preventDefault();
    if (typeof _compareWithSnapshot === 'function') _compareWithSnapshot(snap);
  });
...
function _viewSnapshot(idx) {
  ...
  if (snap.accountLabel) {
    ...
    if (al) al.value = snap.accountLabel;
  }
...
function _returnToCurrent() {
  ...
  if (_currentSnapshot._accountLabel) {
    const al = document.getElementById('accountLabel');
    if (al) al.value = _currentSnapshot._accountLabel;
  }
